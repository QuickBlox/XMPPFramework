...
NSString *const QBGCDAsyncSocketException = @"QBGCDAsyncSocketException";
NSString *const QBGCDAsyncSocketErrorDomain = @"QBGCDAsyncSocketErrorDomain";
...
#endif
NSString *const QBGCDAsyncSocketSSLPeerID = @"QBGCDAsyncSocketSSLPeerID";
NSString *const QBGCDAsyncSocketSSLProtocolVersionMin = @"QBGCDAsyncSocketSSLProtocolVersionMin";
NSString *const QBGCDAsyncSocketSSLProtocolVersionMax = @"QBGCDAsyncSocketSSLProtocolVersionMax";
NSString *const QBGCDAsyncSocketSSLSessionOptionFalseStart = @"QBGCDAsyncSocketSSLSessionOptionFalseStart";
NSString *const QBGCDAsyncSocketSSLSessionOptionSendOneByteRecord = @"QBGCDAsyncSocketSSLSessionOptionSendOneByteRecord";
NSString *const QBGCDAsyncSocketSSLCipherSuites = @"QBGCDAsyncSocketSSLCipherSuites";
#if !TARGET_OS_IPHONE
NSString *const QBGCDAsyncSocketSSLDiffieHellmanParameters = @"QBGCDAsyncSocketSSLDiffieHellmanParameters";
#endif

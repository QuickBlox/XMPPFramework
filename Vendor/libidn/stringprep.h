 ...
 * the GNU Ge`neral Public License as published by the Free
...
extern IDNAPI int stringprep_4i(uint32_t *ucs4, size_t *len, size_t maxucs4len,
                                Stringprep_profile_flags flags,
...
extern IDNAPI int stringprep_profile(const char *in, char **out,
                                     const char *profile,
                                     Stringprep_profile_flags flags);

extern IDNAPI const char *stringprep_strerror(Stringprep_rc rc);

extern IDNAPI const char *stringprep_check_version(const char *req_version);
...
extern IDNAPI uint32_t *stringprep_utf8_to_ucs4(const char *str, ssize_t len,
                                                size_t *items_written);
extern IDNAPI char *stringprep_ucs4_to_utf8(const uint32_t *str, ssize_t len,
                                            size_t *items_read,
                                            size_t *items_written);
...
extern IDNAPI char *stringprep_convert(const char *str, const char *to_codeset,
